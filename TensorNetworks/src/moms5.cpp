                    ...
                    for(int i4=0; i4<sz_sphere; i4++){
                        ...
                        for(int i5=0; i5<sz_sphere; i5++){
                            ...
                            // for(int i6=0; i6<sz_sphere; i6++){
                                ...
                                double w = p1*m_1+p2*m_2+p3*m_3+p4*m_4+p5*m_5;
                                w += lmbd12*m_1*m_2+lmbd13*m_1*m_3+lmbd14*m_1*m_4+lmbd15*m_1*m_5+lmbd23*m_2*m_3+lmbd24*m_2*m_4+lmbd25*m_2*m_5;
                                w += lmbd34*m_3*m_4+lmbd35*m_3*m_5+lmbd45*m_4*m_5;
                                double f = exp(w);
                                double dm = dm_1*dm_2*dm_3*dm_4*dm_5;
                                Z += f*dm;
                                m1 += f*m_1*dm;
                            // }
                        }
